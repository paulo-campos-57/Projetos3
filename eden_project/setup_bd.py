...
CARTAZ = "assets/imagens/CartazFilme.jpg"
MIDIA = "assets/imagens/CartazFilme.jpg"
...
def configurar_bd():
    ...
    # Lista 1
    criar_user("emma_t", "emma.t@example.com", "12345678", "Emma", "Thompson")
    criar_user("alex_r", "alex.r@example.com", "12345678", "Alexander", "Ramirez")
    ...
    criar_user("aiden_l", "aiden.l@example.com", "12345678", "Aiden", "Lee")
    ...
    criar_user("oliver_b", "oliver.b@example.com", "12345678", "Oliver", "Brown")
    ...
    criar_user("leo_m", "leo.m@example.com", "12345678", "Leo", "Martinez")
    ...
    criar_user("andrew_d", "andrew.d@example.com", "12345678", "Andrew", "Davis")
    criar_user("penelope_l", "penelope.l@example.com", "12345678", "Penelope", "Lee")
    criar_user("william_s", "william.s@example.com", "12345678", "William", "Smith")
    criar_user("addison_b", "addison.b@example.com", "12345678", "Addison", "Brown")
    criar_user("caleb_n", "caleb.n@example.com", "12345678", "Caleb", "Nguyen")
    criar_user("victoria_k", "victoria.k@example.com", "12345678", "Victoria", "Kim")
    criar_user("gabriel_p", "gabriel.p@example.com", "12345678", "Gabriel", "Patel")
    criar_user("clara_r", "clara.r@example.com", "12345678", "Clara", "Robinson")
    criar_user('MarcosSerra', 'marquinhosserragens@gmail.com', '12345678', 'Marcos', 'Serra')
